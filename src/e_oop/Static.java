...
public class Static {
	...
	public static void main(String[] args) {
		 ...
		 * - static이 붙은 것 : 클래스 멤버(클래스 변수, 클래시 메서드)
		...
		System.out.println(cm.classVar);
		cm.classMethod();
		//객체를 통해서도 클래스 맴버에 접근할 수 있지만 좋은 방법은 아니다.
		
		ClassMember cm2 = new ClassMember();
		
		System.out.println("변경 전");
		System.out.println("cm : " + cm.instanceVar);
		...
		System.out.println("classMember : " + cm.classVar);
		System.out.println("classMember2 : " + cm2.classVar);
