...
public class RegularExpression {
	...
	public static void main(String[] args) {
		 ...
		 * \D	숫자가 아닌 문자
		 * (?i)	뒷 문자의 대소문자 구분 안함
		 * \	정규표현식에서 사용되는 특수문자 표현  // \는 이스케이프 문자 라고 한다.
		 */
		
		String str = "abc123";
		
//		String regex = "[a-z]{3}[0-9]{1,3}"; //패턴을 표현할때는 좁게 표현하는 것이 좋다.
//		String regex = "[a-z0-9]+";
//		String regex = "\\w*";
//		String regex = ".*";
...
//		System.out.println(m.matches());
		...
		String email = "limm2770@naver.com";
		String regexEmail = "[a-z0-9_-]{5,20}@[a-zA-Z]+\\.(?i)(com|net|org|([a-z]{2}\\.kr))$";
				
		String phoneNumber = "010-2692-7981";
		String regexphoneNumber = "^0\\d{1,3}-\\d{3,4}-\\d{4}";
		...
		Pattern p3 = Pattern.compile(regexphoneNumber);
