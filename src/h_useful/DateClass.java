...
public class DateClass {
	...
	public static void main(String[] args) {
		...
		//날짜 -> 포멧 -> 문자열
		SimpleDateFormat sdf1 = new SimpleDateFormat("yyyy-MM-dd"); // 형식지정
		SimpleDateFormat sdf2 = new SimpleDateFormat("HH:mm:ss.sss");
		SimpleDateFormat sdf3 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		SimpleDateFormat sdf4 = new SimpleDateFormat("yy-MM-dd hh:mm:ss a");
		
		System.out.println(sdf1.format(today)); //format 으로 today 현재날짜를 호출
		...
		cal.set(2019, 11, 17); // 2019/12/17(월은 0부터 시작) // 월은 0부터시작하여 11은 12월이다.
