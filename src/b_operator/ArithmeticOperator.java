...
public class ArithmeticOperator {
	...
	public static void main(String[] args) {
		...
		long e1 = 100000 * 100000; // --> 타입 설정을 안할시 기본 정수는 int가 된다.
		...
		float f2 = 10 / 4f;
		System.out.println(f2); // 2.5 (접미사 활용 중요 위와 동일)
		...
		int the = t1 + t2 + t3;
		double te = (int)(the / 3d * 10 + 5) / 10;
		System.out.println("합계 : " + the + " / 평균 : " + te);
	}
